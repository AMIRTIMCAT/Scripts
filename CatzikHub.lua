...
local function flyTo(destinationCFrame)
	...
	local targetAbove = CFrame.new(destinationCFrame.Position + Vector3.new(0, 250, 0), destinationCFrame.Position)
...
local function updateOptions()
	...
	optionsFrame.Size = UDim2.new(0, 260, 0, #options * 34)
end
