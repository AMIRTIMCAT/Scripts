...
GUI:CreateMain({
    ...
    Theme = {
        ...
        Accent = Color3.fromRGB(236, 80, 251),
...
GUI:CreateButton({
    ...
    text = "Notify", 
    callback = function()
        GUI:CreateNotify({title = "Welcome", description = "Welcome to the Nova Axis! This is a notification exampled. You can use this to inform users about important events or actions. You can customize the title and description to fit your needs. description can be multiple lines long and will adjust its size based on the content."})
    end
})
